# GuadaClaw — 智能 AI 对话平台

> 智能 AI 对话系统，支持 ReAct Agent、多模型适配、RAG 知识库检索、MCP 工具调用与 Skills 技能框架，深度集成 OpenClaw 能力。目标是打造一个可用、易用、好用的个人智能助理。**目前处于早期开发阶段，部分功能正在持续快速迭代中。**
...
- **GitHub**: https://github.com/andoaidlaksldk/GuadaClaw
...
GuadaClaw 是一个功能完备的 AI 对话和工作辅助平台，集成了**浏览器自动化**、 **RAG 知识库**、**MCP 协议** 和 **Skills 技能框架**，深度集成 OpenClaw 能力，支持多种模型提供商，可作为企业内部 AI 中台、聊天机器人后端或个人智能助理使用。
...
GuadaClaw 的核心是一个实现了 **ReAct (Reasoning + Acting) 模式** 的多轮自治循环引擎：
...
![Agent 架构](./images/context-architecture.png)
...
知识库模块实现了完整的 **检索增强生成 (RAG)** 流程，支持 Agent 自助多轮搜索与文档写入。→ [详细文档](docs/knowledge-base.md)
